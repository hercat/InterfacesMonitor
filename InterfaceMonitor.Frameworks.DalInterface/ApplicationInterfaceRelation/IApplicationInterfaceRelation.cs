...
namespace InterfaceMonitor.Frameworks.DalInterface
{
    public interface IApplicationInterfaceRelation
    {
        ...
        ApplicationInterfaceRelation GetApplicationInterfaceRelation(IDbCommand idbcmd, Guid appid, Guid interfaceid);
        bool DeleteApplicationInterfaceRelationById(IDbCommand idbcmd, Guid id);
        bool DeleteApplicationInterfaceRelation(IDbCommand idbcmd, Guid appid, Guid interfaceid);
